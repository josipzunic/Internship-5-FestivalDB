...
Data is imported in pgAdmin 4 by right clicking on the table we want to add data to and choosing the "Import/Export data" option from the dropdown menu. Make sure to check the "Header" check under "Options" when importing data. <br />
